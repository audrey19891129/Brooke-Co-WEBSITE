<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="WebApplicationBrookeAndCo.WebForm1" %>
...
<body>
	...
	<header id="clientEmail" email="">
		<div class="header"><h1>Entertainment for all... at half the price!</h1></div>
		<div id="cartDiv">
			...
			<form action="" id="LoginForm">
				<div class="LoginPageBody">
					<div id="divTdRegist">
						...
						<div class="regist"><input type="text" id="txtName" value="" pattern="[A-Za-z -]{2,15}" /></div>
						<div><label>First name : </label></div>
						<div class="regist"><input type="text" id="txtFName" value="" pattern="[A-Za-z -]{2,15}" /></div>
						...
						<div class="regist"><input type="text" id="txtUsername" pattern="[A-Za-z0-9 -@&$]{5,15}"></div>
						<div><label>Password : </label></div>
						<div class="regist"><input type="password" id="txtPassW" pattern="[A-Za-z0-9 -@&$]{8,15}"></div>
					</div>
					<div id="divTgLog">
						<div><label>Username : </label></div>
						<div id="b5"><input type="text" id="txtUsernameLogIn" pattern="[A-Za-z0-9 -@&$]{5,15}" /></div>
						<div><label>Password : </label></div>
						<div id="b7"><input type="password" id="txtPassWLogIn" pattern="[A-Za-z0-9 -@&$]{5,15}" /></div>
					</div>
				</div>
